  ...
  <div class="container">
    <div class="col mb-3">
      <div class="text-center">
        <h1 class="fw-bold">S2보고서 업로드정보</h1>
      </div>
      <hr />
    </div>
    ...
    <table class="table table-bordered" style="table-layout: fixed">
      <tbody class="table-group-divider">
        <tr>
          ...
          <td style="width: 75%">
            {{ dbUploadedS2Info.report_s2_originalname }}
            <input
              type="text"
              class="form-control mt-2"
              v-model="dbUploadedS2Info.file_s2Report_originalname"
              v-if="dbUploadedS2Info.file_s2Report_originalname"
            />
            <button
...
export default {
  ...
  methods: {
    ...
    fileDownload() {
      ...
      const dbFilename = this.dbUploadedS2Info.report_s2
