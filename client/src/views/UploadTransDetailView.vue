  ...
  <div class="container">
    <div class="col mb-3">
      <div class="text-center">
        <h1 class="fw-bold">전환보고서 업로드정보</h1>
      </div>
      <hr />
    </div>
    ...
    <table class="table table-bordered" style="table-layout: fixed">
      <tbody class="table-group-divider">
        <tr>
          ...
          <td style="width: 75%">
            {{ dbUploadedTransInfo.report_trans_originalname }}
            <input
              type="text"
              class="form-control mt-2"
              v-model="dbUploadedTransInfo.file_transReport_originalname"
              v-if="dbUploadedTransInfo.file_transReport_originalname"
            />
            <button
