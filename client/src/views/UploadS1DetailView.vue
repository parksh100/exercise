  ...
  <div class="container">
    <div class="col mb-3">
      <div class="text-center">
        <h1 class="fw-bold">S1보고서 업로드정보</h1>
      </div>
      <hr />
    </div>
    ...
    <table class="table table-bordered" style="table-layout: fixed">
      <tbody class="table-group-divider">
        <tr>
          ...
          <td style="width: 75%">
            {{ dbUploadedS1Info.report_s1_originalname }}
            <input
              type="text"
              class="form-control mt-2"
              v-model="dbUploadedS1Info.file_s1Report_originalname"
              v-if="dbUploadedS1Info.file_s1Report_originalname"
            />
            <button
...
export default {
  ...
  async mounted() {
    ...
    this.getList()
    this.getDbUploadS1List()
  },
  unmounted() {},

  methods: {
    async getDbUploadS1List() {
    ...
    fileDownload() {
      ...
      const dbFilename = this.dbUploadedS1Info.report_s1
