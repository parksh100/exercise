  ...
  <div class="container">
    <div class="col mb-3">
      <div class="text-center">
        <h1 class="fw-bold">전환보고서 업로드 수정</h1>
      </div>
      <hr />
    </div>
        ...
        <tr>
          ...
          <td style="width: 75%">
            ...
            <input
              ...
              v-model="dbUploadedTransInfo.report_trans_originalname"
              v-if="dbUploadedTransInfo.report_trans_originalname"
            />
            <!-- <button
        ...
        <tr>
          ...
          <td>
            ...
            <div class="text-end">
              ...
              <button
                class="btn btn-primary me-1 d-print-none"
                @click="doSaveTrans"
              >
                저장
              </button>
...
export default {
  ...
  async mounted() {
    ...
    this.getList()
    this.getDbUploadTransReportList()
  },
  unmounted() {},

  methods: {
    async getDbUploadTransReportList() {
      const loader = this.$loading.show({ canCancel: false })
      const result = await this.$get(`/api/upload/trans/${this.id}`)
      console.log('업로드전환보고서', result)
      this.dbUploadedTransInfo = result
      loader.hide()
    },
    ...
    doSaveTrans() {
      ...
      this.$swal({
        ...
        if (result.isConfirmed) {
          ...
          const r = await this.$put(`/api/upload/trans/${this.id}`, {
            param: {
    ...
    fileDownload() {
      ...
      const dbFilename = this.dbUploadedTransInfo.report_trans
